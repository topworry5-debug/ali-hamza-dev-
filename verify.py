...
def verify_portfolio():
    ...
    checks = {
        ...
        "Scroll Progress Bar Present": 'id="scroll-progress-bar"' in html,
        "Section Dividers Present": html.count('class="section-divider') >= 3,
        "Config Script Included Before Main": 'src="./js/config.js"' in html and html.find('./js/config.js') < html.find('./js/main.js'),
        ...
        "Insights Section Present": 'id="insights"' in html,
        "Insights 3 Articles Present": '5 Signs Your Business Needs WhatsApp Automation' in html and 'AI Automation vs Manual Processes' in html and 'How Fast Should Your Business Website Load?' in html,
        "Insights Key Takeaways Present": html.count('Key Takeaway:') >= 3,
        "Insights Nav Link Present": 'href="#insights"' in html,
